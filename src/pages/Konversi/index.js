...
function Konversi  () {
    ...
    const actionConvert = () => {
        setLoading(true)
        axios.post('https://testadmin.belogherbal.com/api/close/convert', dataConvert,
              {
                    headers: {
                          cancelToken :'',
                ...
                Promise.all([getUSER(), getTOKEN()]).then((res) => {
                    ...
                    //   console.log('data',userData.id)
                      if(userData !== null && tokenData !==null){
                            ...
                            axios.get('https://testadmin.belogherbal.com/api/close/points?customer_id=' + `${userData.id}` + '&status_fld=convertion', {
                                headers: {
                                      cancelToken :'',
